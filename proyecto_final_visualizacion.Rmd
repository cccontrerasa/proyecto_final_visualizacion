...
Los datos han sido proporcionados por dos integrantes del equipo que trabajan en la UTEM.


| Column Name                 | Description                                                            |
|---------------------|--------------------------------------------------------------------------------|
| **Sexo**                    | Genero del alumno : Femenino, Masculino                                |
| **Nacionalidad**            | Nacionalidad del alumno: Chilena, Extranjero                           |
| **Comuna**                  | Comuna de origen del alumno                                            |
| **Region**                  | Región de origen del alumno                                            |
| **Carrera**                 | Carrera en la que se matriculó el alumno                               |
| **Escuela**                 | Escuela a la que pertenece la carrera                                  |
| **Facultad**                | Facultad en la que se dicta la carrera                                 |
| **Campus**                  | Campus donde se encuentra la Facultad                                  |

### **META INFORMATION**

**Title:** Distribución de los alumnos de la UTEM

**Summary:**\
Esta BD contiene los datos de los alumnos que se han matriculado a alguna carrera que dicta la UTEM.
